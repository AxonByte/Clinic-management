            ...
            <form action="{{ route('superadmin.services.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input name="service_duration" type="number" class="form-control" min="1" value="{{ old('service_duration') }}">
                    </div>
                    <div class="col-md-6">
                        <label>Price ($) <span class="text-danger">*</span></label>
                        <input name="default_price" type="number" step="0.01" class="form-control" min="0" value="{{ old('default_price') }}" required>
                    </div>
                </div>
                ...
                <div class="form-check mb-3">
                    <input name="has_discount" type="checkbox" class="form-check-input" id="hasDiscount" {{ old('has_discount') ? 'checked' : '' }}>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input name="discount_value" type="number" step="0.01" class="form-control" min="0" value="{{ old('discount_value') }}">
                    </div>
                </div>
