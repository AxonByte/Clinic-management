        ...
        <a href="#" class="navbar-brand">
            ...
            <div class="logo-main">
                <div class="logo-normal">
                  <img src="{{ asset('assets/images/RCH_Logo.png')}}" alt="" height="80px">
                </div>
                <div class="logo-mini">
    ...
    <div class="sidebar-body pt-0 data-scrollbar">
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#" role="button" aria-expanded="false" aria-controls="sidebar-user">
                    <svg class="icon-32" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                                <path fill-rule="evenodd" clip-rule="evenodd" d="M9.5 12.5537C12.2546 12.5537 14.4626 10.3171 14.4626 7.52684C14.4626 4.73663 12.2546 2.5 9.5 2.5C6.74543 2.5 4.53737 4.73663 4.53737 7.52684C4.53737 10.3171 6.74543 12.5537 9.5 12.5537ZM9.5 15.0152C5.45422 15.0152 2 15.6621 2 18.2464C2 20.8298 5.4332 21.5 9.5 21.5C13.5448 21.5 17 20.8531 17 18.2687C17 15.6844 13.5668 15.0152 9.5 15.0152ZM19.8979 9.58786H21.101C21.5962 9.58786 22 9.99731 22 10.4995C22 11.0016 21.5962 11.4111 21.101 11.4111H19.8979V12.5884C19.8979 13.0906 19.4952 13.5 18.999 13.5C18.5038 13.5 18.1 13.0906 18.1 12.5884V11.4111H16.899C16.4027 11.4111 16 11.0016 16 10.4995C16 9.99731 16.4027 9.58786 16.899 9.58786H18.1V8.41162C18.1 7.90945 18.5038 7.5 18.999 7.5C19.4952 7.5 19.8979 7.90945 19.8979 8.41162V9.58786Z" fill="currentColor"></path></svg>                        
                        <span class="item-name">Superadmin</span>
                    </a>
                </li>
                
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-patient" role="button" aria-expanded="false" aria-controls="sidebar-patient">
                    <svg class="icon-32" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                                <path fill-rule="evenodd" clip-rule="evenodd" d="M9.5 12.5537C12.2546 12.5537 14.4626 10.3171 14.4626 7.52684C14.4626 4.73663 12.2546 2.5 9.5 2.5C6.74543 2.5 4.53737 4.73663 4.53737 7.52684C4.53737 10.3171 6.74543 12.5537 9.5 12.5537ZM9.5 15.0152C5.45422 15.0152 2 15.6621 2 18.2464C2 20.8298 5.4332 21.5 9.5 21.5C13.5448 21.5 17 20.8531 17 18.2687C17 15.6844 13.5668 15.0152 9.5 15.0152ZM19.8979 9.58786H21.101C21.5962 9.58786 22 9.99731 22 10.4995C22 11.0016 21.5962 11.4111 21.101 11.4111H19.8979V12.5884C19.8979 13.0906 19.4952 13.5 18.999 13.5C18.5038 13.5 18.1 13.0906 18.1 12.5884V11.4111H16.899C16.4027 11.4111 16 11.0016 16 10.4995C16 9.99731 16.4027 9.58786 16.899 9.58786H18.1V8.41162C18.1 7.90945 18.5038 7.5 18.999 7.5C19.4952 7.5 19.8979 7.90945 19.8979 8.41162V9.58786Z" fill="currentColor"></path></svg>                        
                    ...
                    <ul class="sub-nav collapse" id="sidebar-patient" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link " href="{{ route('superadmin.hospitals.index') }}">
                                ...
                                <span class="item-name">All Hospital</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="{{ route('superadmin.hospitals.create') }}">
                                ...
                                <i class="sidenav-mini-icon"> U </i>
                                <span class="item-name">Add New Hostipat</span>
                            </a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="{{ route('superadmin.subscription_packages.create') }}">
                                ...
                                <i class="sidenav-mini-icon"> U </i>
                                <span class="item-name">Add New packages</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="#">
                                ...
                                <i class="sidenav-mini-icon"> U </i>
                                <span class="item-name">Subscription Requests</span>
                            </a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul class="sub-nav collapse" id="sidebar-patient" data-bs-parent="#sidebar-menu">
                        <li class="nav-item">
                            <a class="nav-link " href="#">
                                ...
                                <i class="sidenav-mini-icon"> U </i>
                                <span class="item-name">Active Hospitals</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="#">
                                ...
                                <i class="sidenav-mini-icon"> U </i>
                                <span class="item-name">Inactive Hostipats</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="#">
                                ...
                                <i class="sidenav-mini-icon"> U </i>
                                <span class="item-name">Expired</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="#">
                                ...
                                <i class="sidenav-mini-icon"> U </i>
                                <span class="item-name">Registered Patient</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="#">
                                ...
                                <i class="sidenav-mini-icon"> U </i>
                                <span class="item-name">Registered Doctor</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="#">
                                ...
                                <i class="sidenav-mini-icon"> U </i>
                                <span class="item-name">Subscription Report</span>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item">
                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor"></svg>
