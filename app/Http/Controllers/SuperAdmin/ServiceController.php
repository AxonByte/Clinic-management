...
class ServiceController extends Controller
{
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            return DataTables::of($query)
                ->addColumn('category', fn($s) => $s->category->name ?? '-')
                ->addColumn('subcategory', fn($s) => $s->subcategory->name ?? '-')
                ...
                ->addColumn('actions', function ($s) {
                    $editUrl = route('superadmin.services.edit', $s->id);
                    $deleteUrl = route('superadmin.services.destroy', $s->id);
                    $csrf = csrf_field();
    ...
    public function create()
    {
        ...
        return view('superadmin.services.create', compact('categories', 'subcategories'));
    }
    ...
    public function edit(Service $service)
    {
        $categories = Category::all();
        $subcategories = Subcategory::all();
        return view('superadmin.services.edit', compact('service', 'categories', 'subcategories'));
    }
