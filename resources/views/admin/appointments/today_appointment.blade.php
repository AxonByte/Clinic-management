         ...
         <div class="card">
            <div class="card-header d-flex justify-content-between">
               <div class="header-title">
                  <h4 class="card-title">Todays Appointments</h4>
               </div>
            ...
            <div class="card-body">
                <div class="tab-content pt-3">
                            <table id="today_appointment" class="table table-striped">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Patient</th>
...
<script>
$(function () {
    const table = $('#today_appointment').DataTable({
        processing: true,
        serverSide: true,
        destroy: true,
        scrollX: true,
        ...
        responsive: true,
        ajax: {
            url: "{{ route('admin.appointment.todays') }}",
            type: "GET"
        },
        columns: [
